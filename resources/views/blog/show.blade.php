                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-update" href="{{url('admin/blog/'.$v->art_id.'/edit')}}">修改</a>
                                <a class="link-del" href="javascript:void (0)" onclick="del({{$v->art_id}})">删除</a>
                            </td>
                        </tr>
                         @endforeach
                    </table>
                    <div class="list-page">{!! $artList->links()!!}</div>
                </div>
            </form>
        </div>
    </div>
